                            ...
                            <div class="col-12 col-md-6">
                                <div class="d-flex">
                                    <div class="d-flex flex-column align-items-center me-3">
                                        <ToggleBtnComponent :target="index" :activeTargetIndex="activePageIndex" @toggle="togglePage(index)"></ToggleBtnComponent>
                                    </div>
                                    <div>
                                        <div>
                                            <div>By {{ event.author_name }}</div>
                                            <div>Created {{ event.f1_created_at }}</div>
                                            <VotesComponent :event_id="event.id" :votes="event.votes" :voted="event.voted == 'yes' ? true : false"></VotesComponent>
                                        </div>
